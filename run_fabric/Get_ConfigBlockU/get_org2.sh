...
# 获取配置块
peer channel fetch config config_block_2.pb -o $ORDERER_CONTAINER \
    -c $CH_NAME --tls --cafile $TLS_ROOT_CA

# 转换为json
configtxlator proto_decode --input config_block_2.pb --type common.Block \
    --output config_block_2.json

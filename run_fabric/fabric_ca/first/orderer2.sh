...
# 向fabric-ca发起注册请求
# echo -e "\nREGISTER"
# fabric-ca-client register --id.name orderer2 --id.secret orderer2pw --id.type orderer
# fabric-ca-client register --id.name orderer2Admin --id.secret orderer2Adminpw --id.type admin
...
fabric-ca-client enroll -u http://orderer:ordererpw@${fabric_ca_server_host} -M ${c_dir}/ordererOrganizations/example.com/orderers/orderer2.example.com/msp --csr.hosts localhost --csr.hosts orderer2.example.com
...
# peer0 tls
echo -e "\nPEER TLS"
fabric-ca-client enroll -u http://orderer:ordererpw@${fabric_ca_server_host}  -M ${c_dir}/ordererOrganizations/example.com/orderers/orderer2.example.com/tls --enrollment.profile tls --csr.hosts localhost --csr.hosts orderer2.example.com
...
# cp ${c_dir}/ordererOrganizations/example.com/orderers/orderer2.example.com/tls/tlscacerts/* ${c_dir}/ordererOrganizations/example.com/msp/tlscacerts/tlsca.example.com-cert.pem
